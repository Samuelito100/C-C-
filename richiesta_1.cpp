...
int estrazione (int a, int b){ //faccio una funziona per eseguire 2 istruzioni a scelta dell'utente
    ...
    printf("scegli\n");
    scanf("%d",&scelta);
    while (scelta<1||scelta>2)      //controllo se il valore inserito sia corretto o meno
    {
...
int moltiplicazione (int a,int b,int c){        //funzione per scegliere 3 operazioni variabili
